<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%	Map<String,String> categoria = (Map<String,String>) request.getAttribute("categoria"); %>
<%	List<Map<String,String>> prodotti = (List<Map<String,String>>) request.getAttribute("prodotticategoria");%>
...
<header class="main-header">
	...
	<h1><%=categoria.get("nomecategoria") %></h1>
	<hr>
	...
	<div class="col-lg-4 col-md-3 col-sm-3  card" >
		<img class="imgCard"src="<%=m.get("URLImmagine")%>"
			...
			if (u.getRuolo().equals("cliente")) {
			%>
			<form method="get" action="/prodotti/aggiungicarrello">
				<input type="text" name="id" value="<%=m.get("idProdotto")%>" hidden>
			...
			<form method="get" action="/prodotti/formmodifica">
			<input type="number" name="id" value="<%=m.get("idProdotto")%>" hidden>
				<button type="submit" class="btn btn-info">MODIFICA</button>
			</form>
			<form method="get" action="/prodotti/elimina">
			<input type="number" name="id" value="<%=m.get("idProdotto")%>" hidden>
