...
<%
List<Map<String, String>> prodotti = (List<Map<String, String>>) request.getAttribute("prodotti");
%>
...
<link rel="stylesheet" href="elencoprodotti.css" type="text/css">
...
<header class="main-header">
	...
	<div class="col-lg-4 col-md-3 col-sm-3  card" >
		<img class="imgCard"src="<%=m.get("URLImmagine")%>"
			...
			<input type="text" name="id" value="<%=m.get("id")%>" hidden>
			...
			<input type="number" name="id" value="<%=m.get("id")%>" hidden>
